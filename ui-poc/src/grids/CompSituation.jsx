...
const CompSituation = () => {
  ...
  const fetchData = useFetchData(`${BASE_URL}/motor-health/fetch-motor-health`);
  const viewFetchData = useViewFetchData(`${BASE_URL}/motor-health/fetch-motor-health-${viewFilter}`);
